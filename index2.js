...
console.log('task 1 c:', 1999(Party));
...
console.log (result)('task 4', game('paper', computer));
...
function annoyingSong(number){
      ...
      return '${i} bottles of soda on the wall, ${i} bottle os soda, take on down pass it around $ {i - 1} bottles of soda on the wall';
}
